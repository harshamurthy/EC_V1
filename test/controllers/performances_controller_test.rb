...
class PerformancesControllerTest < ActionController::TestCase
  ...
  test "should create performance" do
    assert_difference('Performance.count') do
      post :create, performance: { exercise_id: @performance.exercise_id, name: @performance.name, value: @performance.value }
    end
  ...
  test "should update performance" do
    patch :update, id: @performance, performance: { exercise_id: @performance.exercise_id, name: @performance.name, value: @performance.value }
    assert_redirected_to performance_path(assigns(:performance))
  end
